...
This is particularly useful when the same group of fields (a section) is used for different :ref:`Types <types-anchor>`.
Section templates speed up the creation and modification of :ref:`Types <types-anchor>`, eliminating the need to
repeatedly create recurring sections.

Section templates can be accessed at the top right corner at **Framework => Section Templates**.

.. figure:: img/section_templates/section_templates_systemlink.png
    :width: 200
...
.. figure:: img/section_templates/section_templates_overview.png
    :width: 700
...
--------------------------
In this form a section template can be built the same way as in :ref:`Type <types-anchor>` configurations by drag and drop of elements
...
.. figure:: img/section_templates/section_templates_creation.png
    :width: 700
...
-----------------------
After a section template has been created it can be used in :ref:`Type <types-anchor>` configurations. In the sidebar of
the :ref:`Type <types-anchor>` configuration are two areas, the **Global Section Templates** area  which contain all
global and predefined section templates and the **Section Templates** area which contains all Standard section templates.
They can be added to the :ref:`Type <types-anchor>` configuration via drag and drop the same way a new section would be
added. **Global Section Templates** are not editable inside the :ref:`Type <types-anchor>` configuration.

.. figure:: img/section_templates/section_templates_usage.png
    :width: 700
...
^^^^^^^^^^^^^^^^^^^^^^^^^^
- It can be dropped multiple times inside the same :ref:`Type <types-anchor>` configuration
- After it is dragged inside the :ref:`Type <types-anchor>` configuration it can be further modified and additional
  fields can be added or existing ones can be deleted
...
- There is no programatical connection between the **Standard Section Template** and the :ref:`Type <types-anchor>`

| 

Global Section Templates
^^^^^^^^^^^^^^^^^^^^^^^^
- It can be dropped only once inside the same :ref:`Type <types-anchor>` configuration
- It can not be further modified after it was added to a :ref:`Type <types-anchor>` configuration
- Changes to the global section template in the template configuration will affect all existing instances
  ...
  - **Example 3:** Deleting a global section template will also delete the section and its data from all
  - :ref:`Types <types-anchor>` and :ref:`Objects <objects-anchor>` which are using it
...
.. figure:: img/section_templates/section_templates_table_actions.png
    :width: 300
...
.. |action_preview_img| image:: img/section_templates/section_templates_table_action_preview.png
    :width: 20
    :alt: Open Preview
...
.. |action_edit_img| image:: img/section_templates/section_templates_table_action_edit.png
    :width: 20
...
Editing a global section template in this form will affect all :ref:`Types <types-anchor>` and
:ref:`Objects <objects-anchor>` using this template.

| 

**Clone Section Template** |action_clone_img|

.. |action_clone_img| image:: img/section_templates/section_templates_table_action_clone.png
    :width: 20
...
.. |action_transform_img| image:: img/section_templates/section_templates_table_action_transform.png
    :width: 20
...
template on :ref:`Types <types-anchor>` are not tracked. Users should consider that this action can not be
undone. This action is only available to standard templates.

| 

**Global Template Indicator** |action_global_img|

.. |action_global_img| image:: img/section_templates/section_templates_table_action_global.png
    :width: 20
    :alt: Global Template Indicator

This is just an indicator that this template type is **Global** and should represent that
this :ref:`Types <types-anchor>` can not be transformed. All predefined templates are also global
templates.
...
.. |action_delete_img| image:: img/section_templates/section_templates_table_action_delete.png
    :width: 20
    :alt: Delete Template

With this action section templates can be deleted. Consider that deleting a global section template will also
remove it and all set values from :ref:`Types <types-anchor>` and :ref:`Objects <objects-anchor>`. The amount of
affected :ref:`Types <types-anchor>` and :ref:`Objects <objects-anchor>` will be displayed in the confirmation popup.

Predefined templates are not deletable.
