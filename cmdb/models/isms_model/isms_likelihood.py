...
class IsmsLikelihood(CmdbDAO):
    ...
    def __init__(self, public_id: int, name: str, calculation_basis: str, descrption: str = None):
        """
...
# -------------------------------------------------- CLASS FUNCTIONS ------------------------------------------------- #
    ...
    def to_json(cls, instance: "IsmsLikelihood") -> dict:
        ...
        Raises:
            IsmsLikelihoodToJsonError: If the IsmsRiskClass could not be converted to a json compatible dict
