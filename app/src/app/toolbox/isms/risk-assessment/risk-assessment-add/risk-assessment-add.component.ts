...
//    isEditMode = this.route.snapshot.paramMap.has('id');
//    riskAssessmentId = this.isEditMode
...
//    isView = this.router.url.includes('/view/');
...
//    * ═════════════════════════════════════════════════════════════════════════ */
//   ngOnInit(): void {
//     console.log('RiskAssessmentAddComponent initialized');
...
//     this.riskAssessmentId = this.isEditMode || this.isView
...
//       if (this.isEditMode) {
//         // Edit mode: use data as-is
//         this.patchFormWithData(state.riskAssessment);
//       } else if (this.isView) {
//         // View mode: use data and disable form
//         this.patchFormWithData(state.riskAssessment);
//         this.form.disable({ emitEvent: false });
//       } else {
//         // Add mode with state data: treat as duplicate
//         const data = { ...state.riskAssessment };
//         delete data.public_id; // Remove public_id for new record
//         this.patchFormWithData(data);
//       }
//     } else {
//       // No state data: assume coming from list is required
//       this.router.navigate(['/isms/risk-assessments']); // Redirect to list
...
//             impact_category_id: [impact.impact_category_id],
